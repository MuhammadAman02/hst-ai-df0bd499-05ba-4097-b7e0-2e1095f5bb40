...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-joylo-navy text-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-joylo-blue to-joylo-purple flex items-center justify-center">
      ...
      {/* Architects Section */}
      <div className="section-fade-in" id="architects">
        <ArchitectsSection />
      </div>

      {/* How It Works Section */}
      <div className="section-fade-in" id="how-it-works">
        <HowItWorksSection />
      </div>

      {/* Social Proof Section */}
      <div className="section-fade-in" id="examples">
        <SocialProofSection />
      </div>
      ...
      <footer className="bg-joylo-navy-light border-t border-glass-border py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                The AI-native platform for building production-grade applications with human expertise.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <a href="#" className="block text-gray-400 hover:text-white transition-colors">Architects</a>
          ...
          <div className="border-t border-glass-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2024 Joylo AI. All rights reserved.</p>
