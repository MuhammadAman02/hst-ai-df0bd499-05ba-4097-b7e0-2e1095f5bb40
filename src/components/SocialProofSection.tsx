      ...
      <div className="container mx-auto px-6">
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="glass-card p-6 hover:scale-105 transition-all duration-300">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-joylo-blue to-joylo-purple flex items-center justify-center text-white font-bold">
                  {testimonial.avatar}
                </div>
                <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-2">
                  <ExternalLink className="w-4 h-4 text-joylo-blue" />
                  <span className="text-gray-400">Project:</span>
                  <span className="text-white">{testimonial.project}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-joylo-purple" />
        ...
        <div className="glass-card p-8 max-w-4xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-joylo-blue mb-2">1,247</div>
              <div className="text-gray-400">Apps Shipped</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-joylo-purple mb-2">99.2%</div>
              <div className="text-gray-400">Success Rate</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-emerald-500 mb-2">4.2 days</div>
              <div className="text-gray-400">Avg. Launch Time</div>
            </div>
            <div>
